...
// DefaultTrackers is a list of public trackers to be added to every torrent.
// We format this as [][]string because t.AddTrackers expects tiers.
// We treat every tracker as a separate tier for maximum redundancy.
